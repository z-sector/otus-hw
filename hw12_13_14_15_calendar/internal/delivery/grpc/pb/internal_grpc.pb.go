...
const (
	InternalService_Ping_FullMethodName = "/InternalService/Ping"
)
...
func (c *internalServiceClient) Ping(ctx context.Context, in *PingReq, opts ...grpc.CallOption) (*PingResp, error) {
	out := new(PingResp)
	err := c.cc.Invoke(ctx, InternalService_Ping_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInternalServiceServer) Ping(context.Context, *PingReq) (*PingResp, error) {
...
func _InternalService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InternalServiceServer).Ping(ctx, req.(*PingReq))
	}
...
var InternalService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/proto/internal/internal.proto",
}
